...
## ⚠️ Deploy-এর আগে সবার আগে করো (Step 0)

**CLAUDE.MD পড়ো** — প্রতিটি deploy-এর আগে CLAUDE.MD চেক করতে হবে:
- Artifact Registry image limit: **সর্বোচ্চ ৩টি** (বেশি হলে আগে পুরোনো delete করো)
- শেষ deploy তথ্য দেখো — কোন revision live আছে
- Environment setup status — সব tool ঠিকঠাক আছে কিনা
...
- CLAUDE.MD-এর "শেষ Deploy তথ্য" section আপডেট করো (তারিখ, revision)।
- ⚠️ **অবশ্যই বলো:** "স্যার, Artifact Registry-তে ৩টির বেশি image থাকলে পুরোনোগুলো delete করুন।"
